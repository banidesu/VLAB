...
<html lang="en" class="light-style layout-menu-fixed" dir="ltr" data-theme="theme-default" data-assets-path="<?= base_url() ?>assets/vendor" data-template="vertical-menu-template-free">
...
<head>
    ...
    <link rel="stylesheet" href="<?= base_url() ?>assets/vendor/vendor/libs/apex-charts/apex-charts.css">
