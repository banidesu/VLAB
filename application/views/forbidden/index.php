...
<html
  ...
  data-assets-path="<?= base_url() ?>assets/vendor"
...
>
  <head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="<?= base_url() ?>assets/vendor/img/favicon/favicon.ico" />
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="<?= base_url() ?>assets/vendor/vendor/css/pages/page-misc.css" />
    <!-- Helpers -->
  ...
  <body>
    ...
    <div class="container-xxl container-p-y">
      <div class="misc-wrapper">
        ...
        <div class="mt-3">
          <img
            src="<?= base_url() ?>assets/vendor/img/illustrations/page-misc-error-light.png"
