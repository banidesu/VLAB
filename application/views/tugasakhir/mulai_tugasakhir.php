                        ...
                        <div>
                           <div class="widget-box">
                              <div class="widget-header widget-header-blue widget-header-flat">
                                 <h4 class="widget-title lighter">Tugas Akhir</h4>
                              </div>
                             <div class="widget-body">
                              <div class="widget-main" style="overflow-x:scroll;">
                                 <div id="fuelux-wizard-container">
                                    ...
                                    <hr />
                                    <form action="<?php echo base_url();?>ceklp/cek" method="post" >
                                       <div class="step-content pos-rel">
                                          ...
                                          <div class="step-pane active" data-step="<?php echo $no;?>">
                                             <div class="col-xs-1 col-sm-12 col-sm-offset-1">
                                                <input type="text" name="kd_bab" value="<?php echo $row->kd_bab;?>" hidden>
                                                <table>
                                                   <tr>
                                                      <th><label class="control-label bolder blue"><?php echo $no;?>.&nbsp;&nbsp;&nbsp;&nbsp;<?php echo $row->soal;?></label>
                                                      </th>
                                                   </tr>
                                                   <tr>
